...
class burgerDeluxe extends Burger {

    private String deluxeTopping1;
    private String deluxeTopping2;

    public burgerDeluxe(String name, double price, String deluxeTopping1, String deluxeTopping2) {
        super(name, price);
        this.deluxeTopping1 = deluxeTopping1;
        this.deluxeTopping2 = deluxeTopping2;
    }
}